 ...
 *
 * <p>Implementations may write to different formats (CSV, JSON, XML) or destinations (filesystem,
 * database). This interface allows the rest of the application to remain independent of the
 * specific format or destination used.
 *
 * @see CsvStockWriter
 */
