 ...
 *
 * <p>Centralizes construction of ControlsFX {@link Notifications} dialogs so that controllers do
 * not need to know about UI components, formatting, or label text. The class cannot be
...
public final class TransactionDialog {
  ...
  /**
   * Displays a confirmation dialog summarizing a completed purchase.
   *
    ...
    Notifications.create()
        ...
        .text(
            "Bought "
                ...
                + "\n"
                + "Cost: "
                + ViewFormatter.price(calc.calculateGross())
                + "\n"
                + "Commission:  "
                + ViewFormatter.price(calc.calculateCommission())
                + "\n"
                + "Total paid:  "
                + ViewFormatter.price(calc.calculateTotal())
                + "\n"
                + "Cash left:   "
  ...
  /**
   * Displays a confirmation dialog summarizing a completed sale.
   *
    ...
    Notifications.create()
        ...
        .text(
            "Sold "
                ...
                + "\n"
                + "Tax:          "
                + ViewFormatter.price(calc.calculateTax())
                + "\n"
                + "Net received: "
                + ViewFormatter.price(calc.calculateTotal())
                + "\n"
